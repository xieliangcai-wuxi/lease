...
public class ApartmentInfoServiceImpl extends ServiceImpl<ApartmentInfoMapper, ApartmentInfo>
    ...
    public ApartmentDetailVo getDetailById(Long id) {
        ...
        //查询图片信息并构造返回体
        List<GraphVo> graphVoList =  graphInfoMapper.getUrlById(ItemType.APARTMENT.getCode(),id);
        ...
        //查询杂项信息并构造返回体
        List<FeeValueVo> feeValueList = feeValueMapper.selectListById(id);
